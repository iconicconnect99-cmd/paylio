...
class KYC(models.Model):
    ...
    identity_image = models.ImageField(upload_to="kyc", null=True, blank=True, default="default.jpg")
    date_of_birth = models.DateTimeField()
    signature = models.ImageField(upload_to="kyc", null=True, blank=True, default="default.jpg")
